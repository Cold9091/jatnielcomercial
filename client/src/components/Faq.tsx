...
const faqCategories: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      {
        question: "Como o curso de marketing digital vai me ajudar profissionalmente?",
        answer: "Nosso curso fornece conhecimentos práticos e atualizados sobre estratégias de marketing digital, incluindo gestão de anúncios pagos nas principais plataformas. Você desenvolverá habilidades valorizadas no mercado, podendo atuar como especialista em marketing digital, gestor de mídia paga ou empreendedor com conhecimentos para impulsionar seu próprio negócio."
      },
      {
        question: "Preciso ter conhecimentos prévios para fazer o curso?",
        answer: "Não, nosso curso é estruturado para atender desde iniciantes até pessoas com alguma experiência. O conteúdo é apresentado de forma progressiva, começando dos fundamentos básicos até técnicas avançadas, permitindo que todos possam acompanhar e evoluir no próprio ritmo."
      },
      {
        question: "O certificado tem reconhecimento oficial?",
        answer: "Sim, nosso certificado é reconhecido pelo INEFOP (Instituto Nacional de Emprego e Formação Profissional), o que confere credibilidade e validade formal ao seu aprendizado, sendo um diferencial importante para o mercado de trabalho."
      },
      {
        question: "Há suporte após o término do curso?",
        answer: "Sim, oferecemos 30 dias de suporte pós-curso para esclarecer dúvidas e auxiliar na aplicação prática do conhecimento. Além disso, os alunos têm acesso a um grupo exclusivo para networking e compartilhamento de oportunidades e informações."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        answer: "Trabalhamos com um modelo flexível de pagamento. Para projetos de desenvolvimento web e design, solicitamos 50% de entrada para iniciar os trabalhos e 50% na entrega final. Para os cursos, oferecemos opções de pagamento integral com desconto ou parcelamento em até 3 vezes sem juros."
      },
      {
        question: "Vocês atendem em todo o território de Angola?",
        answer: "Sim, atendemos clientes em todo o território angolano. Para serviços de desenvolvimento web e design, o atendimento pode ser totalmente remoto. Para os cursos presenciais, nossa sede está localizada na Centralidade do Kilamba, mas também oferecemos possibilidade de cursos in-company para empresas em outras localidades."
      },
      {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Encontre respostas para as perguntas mais comuns sobre nossos serviços e cursos.
          </p>
        </div>
